...
%helpURL = java.net.URL('http://github.com/greasygoat/matlabClass.git')


% 2. What does the command 'clear all' do?
%
% Answer: Clears out all variables so the do not exist
%
...
%
% Answer: conditional loop and counted loop. Counted loop repeats the
% statement for a specific number of times. 
%In a Conditional loop the occurrence of repeats is unknown before hand. 
% 
...
%
% Answer: Not a number. This is the result of operations that have
% undentified numerical results.
%
